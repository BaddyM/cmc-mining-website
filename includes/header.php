    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="projects" class="<?php if($page == 'Projects'){echo 'active';}?>">Projects</a></li>
          <li><a href="blog" class="<?php if($page == 'Blog'){echo 'active';}?>">Blog</a></li>
